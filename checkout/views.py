...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        form_data = {field: request.POST[field] for field in ['full_name', 'email', 'phone_number', 'country', 'postcode', 'town_or_city', 'street_address1', 'street_address2', 'county']}
    ...
    context = {'order_form': order_form, 'stripe_public_key': stripe_public_key, 'client_secret': intent.client_secret}
